...
async function runMigrations() {
  ...
  try {
    ...
    if (tablesExist) {
      console.log('✅ Database tables already exist - skipping migration to preserve data');
      console.log('💡 To reset the database, run: npm run migrate:reset --prefix backend\n');
    ...
    console.log('📋 No existing tables found - running initial migration...\n');
